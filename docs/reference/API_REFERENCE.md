...
| `/api/monitoring/health` | GET        | Authenticated health and capacity summary: provider/Codex-account limits, queues, bounded rolling peaks, and process metrics (account labels are masked) |
